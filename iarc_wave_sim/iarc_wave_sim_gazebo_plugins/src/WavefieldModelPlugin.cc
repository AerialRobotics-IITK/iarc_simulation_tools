...
#include "iarc_wave_sim_gazebo_plugins/WavefieldModelPlugin.hh"
...
// WavefieldModelPluginPrivate
  ...
  class WavefieldModelPluginPrivate
  {
    ...
    public: boost::shared_ptr<::iarc::WavefieldEntity> wavefieldEntity;
...
// WavefieldModelPlugin
  ...
  void WavefieldModelPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
  {
    ...
    // Wavefield
    this->data->wavefieldEntity.reset(new ::iarc::WavefieldEntity(this->data->model));
