...
#include "iarc_wave_sim_gazebo_plugins/Convert.hh"
...
#include "iarc_wave_sim_gazebo_plugins/CGALTypes.hh"
...
void TestExportWaveMesh()
{
  ...
  meshManager.Export(
    gzMesh.get(),
    "/Users/rhys/Code/ros/iarc_ws/tmp/wavefield",
    "dae");
...
void TestExportGridMesh()
{
  ...
  meshManager.Export(
    gzMesh.get(),
    std::string("/Users/rhys/Code/ros/iarc_ws/tmp/").append(name),
    "dae");
