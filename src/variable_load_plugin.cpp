...
void GazeboVarForcePlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
    ...
    ros::SubscribeOptions so = ros::SubscribeOptions::create<iarc_simulation_tools::LoadParams>(
...
void GazeboVarForcePlugin::OnRosMsg(const iarc_simulation_tools::LoadParamsConstPtr& _msg) {
